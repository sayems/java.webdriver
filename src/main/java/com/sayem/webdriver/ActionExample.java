...
public class ActionExample {
    ...
    @Test public void droppable() { driver.get("http://jqueryui.com/demos/droppable/"); WebElement draggable = driver.findElement(By.id("draggable"));
    ...
    public void selectMultiple() throws InterruptedException {
        ...
        Action selectMultiple = builder.build(); selectMultiple.perform();
    }
